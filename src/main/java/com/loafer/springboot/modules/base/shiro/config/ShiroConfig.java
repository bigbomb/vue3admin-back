package com.loafer.springboot.modules.base.shiro.config;

import com.loafer.springboot.modules.base.shiro.filter.OAuth2Filter;
import com.loafer.springboot.modules.base.shiro.realm.OAuth2Realm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        mappingMap.put("/druid/**", "anon"); // sql 监控
        mappingMap.put("/static/apidoc/**", "anon"); // api 文档
        mappingMap.put("/demo/**", "anon"); // demo
        mappingMap.put("/base/captcha.jpg", "anon"); // 图片验证码
        mappingMap.put("/base/login", "anon"); // 登录
