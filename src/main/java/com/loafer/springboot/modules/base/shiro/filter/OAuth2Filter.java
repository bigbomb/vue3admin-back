package com.loafer.springboot.modules.base.shiro.filter;

import com.alibaba.druid.support.json.JSONUtils;
import com.loafer.springboot.common.utils.Constant;
import com.loafer.springboot.common.utils.RequestBody;
...
public class OAuth2Filter extends AuthenticatingFilter {
    ...
    protected boolean onLoginFailure(AuthenticationToken token, AuthenticationException e, ServletRequest request, ServletResponse response) {
        ...
        if (StringUtils.isBlank(message)) {
            message = JSONUtils.toJSONString(R.error(500));
        }
        try {
